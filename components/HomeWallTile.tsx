    ...
    <>
      ...
      {showWord && (
        ...
        <View style={styles.wordChip}>
          <Text style={styles.wordChipText} numberOfLines={1}>{sticker.word}</Text>
        </View>
      )}
    </>
  );
...
const styles = StyleSheet.create({
  ...
  wordChipText: { fontSize: 9, fontFamily: fonts.jp, color: colors.inkDark, textAlign: 'center' },
});
